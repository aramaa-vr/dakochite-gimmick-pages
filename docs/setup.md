...
おちびちゃんズ化ツール（Obichi-chans Converter Tool）でコピー変換したアバターにも、だこちてギミックを設定できます。

進め方の目安:

1. **① 変換元アバター** に通常アバターを指定
2. **② 変換先おちびちゃんズ** で候補を選択
3. **③ 実行（コピー変換）** でコピーを作成
4. その後、このページの手順で **コピー先（おちびちゃんズ側）** を選んでギミックを生成

> ポイント: だこちてギミックのセットアップ対象は、最終的にアップロードしたいアバター（コピー先）を選んでください。
